...
<div id="navigation"><img src="images/navigation.png" width="435" height="180" border="0" usemap="#navigation_links"/>
  <map name="navigation_links" id="navigation_links">
    <area shape="rect" coords="7,117,159,163" href="#" alt="event" />
    <area shape="rect" coords="179,118,296,158" href="#" alt="sponsorship" />
    <area shape="rect" coords="316,115,400,157" href="#" alt="contact" />
    ...
    <area shape="rect" coords="372,74,395,105" href="http://www.linkedin.com/company/healthcare-experience-design-conference/" alt="linkedin" />
    <area shape="rect" coords="11,75,111,105" href="http://www.madpow.com" target="_blank" alt="madpow" />
    <area shape="rect" coords="126,75,214,105" href="http://www.claricode.com" target="_blank" alt="claricode" />
  </map>
</div>
</div> <!--header-->
<div id="content">
...
<?php if (!isset($thankyou)) { ?>
  ...
  <tr>
    <td><a href="http://www.westin.com/boston" target="_blank"><img src="images/venue.jpg" width="230" height="137" alt="venue" /></a></td>
  </tr>
</table>
</div> <!-- sidebar--->

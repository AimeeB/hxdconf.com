...
<html>
  ...
  <body>
    ...
    <div id="flash-div">
    	<p id="flash" class="container_12">X&nbsp;&nbsp;Save the Date for HxD 2013! March 24, 25 &amp; 26, 2013</p>
    </div>
		...
		<div id="container">	
			...
			<div id="content-wrapper" role="main" class="container_12">
						...
						<div id="date-and-place">
							<h4 class="float-left">Save the date for the 2013 Conference<br />March 24, 25 &amp; 26, 2013</h4>
